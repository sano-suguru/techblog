...
const args: JSX.IntrinsicAttributes & Props & { children?: React.ReactNode } = {
  ...
  authorName: "Nossa",
  publishDate: "2020-08-21T16:40+09:00",
  publishDateJP: "2020年 08月 21日",
  ...
  categories: [
    ...
    },
    {
      ...
      categorySlug: "Gatsby.js",
      id: "KZ7JHBbJSncv",
    },
    {
      categoryName: "Contentful",
      categorySlug: "Contentful",
      id: "W373nbvbVmRJ",
    },
    {
      categoryName: "Netlify",
      categorySlug: "Netlify",
      id: "d6azXzsHrxGt",
    },
  ],
  eyecatch:
